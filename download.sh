...
if [ x${USE_CHINA_MIRROR} == "xyes" ]; then
    ...
    curl -OL -C - https://git.babudiu.com/iuxt/offline-kubernetes-install/releases/download/nginx/nginx.tar.gz
else
    ...
    curl -OL -C - https://github.com/iuxt/offline-kubernetes-install/releases/download/nginx/nginx.tar.gz
fi
