...
if [ x${USE_CHINA_MIRROR} == "xyes" ]; then
    ...
    curl -OL -C - https://git.babudiu.com/iuxt/offline-kubernetes-install/releases/download/haproxy/haproxy-1.5.18-9.el7_9.1.x86_64.rpm
else
    ...
    curl -OL -C - https://github.com/iuxt/offline-kubernetes-install/releases/download/haproxy/haproxy-1.5.18-9.el7_9.1.x86_64.rpm
fi
...
cp haproxy-1.5.18-9.el7_9.1.x86_64.rpm ../haproxy/
